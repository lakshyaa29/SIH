/* =========================================================================
   NagrikMitra AI / Sahayak AI — Master Government Services Database
   Contains verified details for 47+ Indian Government Schemes
   ========================================================================= */

export const ALL_GOVERNMENT_SERVICES = [
  ...
  // ------------------ 9. IDENTITY, CERTIFICATES & TRANSPORT ------------------
  {
    id: "uidai-aadhaar",
  ...
  },
  {
    ...
    application_steps: [
      ...
      "Public Information Officer (PIO) is statutorily mandated to reply within 30 days"
    ],
...
export const SERVICE_CATEGORIES = Array.from(
  new Set(ALL_GOVERNMENT_SERVICES.map((s) => s.category))
);
